...
const Nav4 = (props: SVGProps<SVGSVGElement>) => {
	return (
		<svg xmlnsXlink="http://www.w3.org/1999/xlink" {...props} xmlns="http://www.w3.org/2000/svg" width="32"  height="32" ><defs><symbol id="icon_HotGame" viewBox="0 0 32 32">
...
</symbol></defs><use xlinkHref="#icon_HotGame" fill="#67707B"></use></svg>
	);
};
