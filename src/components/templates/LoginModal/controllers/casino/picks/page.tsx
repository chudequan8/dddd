...
import DefButton from '@/components/def/Button'
import { Nav1, Nav2, Nav3, Nav4, Nav5, Nav6, Nav7 } from '@/components/icon/duotone';
			...
			<div className='bg-[#111415] pt-6 mt-6'>
				<div className='max-page-container relative px-10'>
					...
					<div className='mt-[10px] flex items-center'>
						...
						<DefButton icon={Nav1} onClick={navCLickHandle}>Lobby</DefButton>
						<DefButton icon={Nav2} onClick={navCLickHandle}>Top Picks</DefButton>
						<DefButton icon={Nav3} onClick={navCLickHandle}>Slots</DefButton>
						<DefButton icon={Nav4} onClick={navCLickHandle}>Hot Games</DefButton>
						<DefButton icon={Nav5} onClick={navCLickHandle}>Live Casino</DefButton>
						<DefButton icon={Nav6} onClick={navCLickHandle}>Table Games</DefButton>
						<DefButton icon={Nav7} onClick={navCLickHandle}>New Releases</DefButton>
