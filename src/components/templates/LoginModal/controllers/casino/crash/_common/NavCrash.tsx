    ...
    <div className=''>
      ...
      <div className='p-4 bg-[#2b2f37]'>
        <div className='w-full bg-[#191b1f] flex p-1 gap-2'>
          <DefButton onClick={() => setLatestBtnActive(0)} className={`flex-1 ${latestBtnActive == 0 ? 'bg-[#2D3035]' : 'bg-transparent'}`}>My Bets</DefButton>
          <DefButton onClick={() => setLatestBtnActive(1)} className={`flex-1 ${latestBtnActive == 1 ? 'bg-[#2D3035]' : 'bg-transparent'}`}>History</DefButton>
          <DefButton onClick={() => setLatestBtnActive(2)} className={`flex-1 ${latestBtnActive == 2 ? 'bg-[#2D3035]' : 'bg-transparent'}`}>High roolers</DefButton>
          <DefButton onClick={() => setLatestBtnActive(3)} className={`flex-1 ${latestBtnActive == 3 ? 'bg-[#2D3035]' : 'bg-transparent'}`}>Wager contest</DefButton>
        </div>
