    ...
    return (
        <div className="max-page-container">
            ...
            <div className="grid grid-cols-6 gap-5">
                <div className="w-full relative rounded-md overflow-hidden cursor-pointer">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 z-10 px-6 py-4 pb-6" style={{
                        ...
                        <p className="my-2 mx-auto h-[1px]" style={{background: 'rgba(152,167,181,.2)', borderTop: 'rgba(152,167,181,.2)'}}></p>
                        <div className="flex justify-center text-sm text-title gap-2">
